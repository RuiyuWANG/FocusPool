...
from focuspool.env_runner.robomimic_setup import build_robomimic_runner_setup
from focuspool.env_runner.rollout_media import (
...
from focuspool.env_runner.video_recording_wrapper import VideoRecordingWrapper
from focuspool.model.common.rotation_transformer import RotationTransformer
...
class FocusPoolRobomimicImageRunner:
    def __init__(
        self,
        output_dir,
        dataset_path,
        ...
        for chunk_idx in range(n_chunks):
            ...
            while not done:
                ...
                env_action = self.undo_transform_action(
                    action, base_pos=base_pos, base_rot=base_rot
                )
