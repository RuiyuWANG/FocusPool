...
from focuspool.model.common.dino import load_frozen_dinov3_vits16plus
...
class PatchActivationHead(nn.Module):
    ...
    def forward(
        ...
        task_language_tokens: torch.Tensor | None = None,
    ) -> torch.Tensor:
...
def load_checkpoint_payload(path: str | Path, *, map_location="cpu") -> dict:
...
class RVT2Heatmap(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.patch_backbone.load_state_dict(
            payload["patch_backbone_state_dict"],
            strict=True,
        )
